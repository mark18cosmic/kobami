<x-app-layout>
    <div class="p-6 max-w-6xl mx-auto space-y-8">
        ...
        <div class="flex flex-col">
            ...
            <a href="{{ route('vendor.products.create') }}" class="bg-[#022954] hover:bg-[#011e3f] text-white rounded-xl text-base font-semibold h-12 px-6 flex items-center justify-center shadow-md hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-[#022954]/40">
                + Add New Product
            </a>
